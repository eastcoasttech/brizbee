...
namespace Brizbee.QBExportUtility.ViewModels.InventoryAdjustments
{
    public class SyncViewModel : INotifyPropertyChanged
    {
        ...
        public void Sync()
        {
            ...
            try
            {
                ...
                {
                    var adjustments = httpResponse.Data;

                    // Build the request to store adjustments as sales receipts
                    inventoryService.BuildSalesReceiptAddRq(doc, inner, adjustments);
