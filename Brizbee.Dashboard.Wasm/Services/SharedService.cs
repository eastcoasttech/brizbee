...
using Brizbee.Dashboard.Wasm.Serialization;
...
namespace Brizbee.Dashboard.Wasm.Services
{
    public class SharedService(IJSRuntime JSRuntime)
    {
            ...
            get
            {
                if (_punchFilters == null)
                {
                    _punchFilters = new PunchFilters()
                    {
                        ...
                        Tasks = new HashSet<Brizbee.Dashboard.Wasm.Models.Task>(),
        ...
        public Brizbee.Dashboard.Wasm.Models.Task AttemptedTask { get; set; }
