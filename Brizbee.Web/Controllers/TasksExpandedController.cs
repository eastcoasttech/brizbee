...
{
    public class TasksExpandedController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/TasksExpanded/ForPunches")]
        public HttpResponseMessage GetTasksForPunches([FromUri] DateTime min, [FromUri] DateTime max,
            [FromUri] string orderBy = "TASKS/NUMBER", [FromUri] string orderByDirection = "ASC")
        {
