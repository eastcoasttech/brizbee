...
{
    public class QuickAuthController : Controller
    {
        ...
        /// <summary>
        /// Use the Index page of QuickAuth controller to get all endpoints from discovery url
        /// </summary>
        ...
        public ActionResult InitiateAuth(string submitButton)
        {
            switch (submitButton)
            {
                case "Connect to QuickBooks Online":
