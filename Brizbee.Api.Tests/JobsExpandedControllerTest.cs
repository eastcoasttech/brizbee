...
{
    [TestClass]
    public class JobsExpandedControllerTest
    {
        ...
        public JobsExpandedControllerTest()
        {
            // Setup configuration
        ...
        public async System.Threading.Tasks.Task GetAllJobs_Should_ReturnSuccessfully()
        {
            ...
            var response = await client.GetAsync($"api/JobsExpanded");
