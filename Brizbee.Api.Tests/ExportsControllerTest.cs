...
namespace Brizbee.Api.Tests
{
    ...
    public class ExportsControllerTest
    {
        ...
        [TestMethod]
        public async System.Threading.Tasks.Task GetCsv_Should_ReturnSuccessfully()
        {
            // ----------------------------------------------------------------
            // Arrange
            // ----------------------------------------------------------------
            ...
            var inAt = "2021-01-01";
            var outAt = "2021-01-31";

            var response = await client.GetAsync($"api/Exports/Csv?Delimiter=,&InAt={inAt}&OutAt={outAt}");
