//
//  PunchesExpandedControllerTest.cs
//  BRIZBEE API
//
...
{
    [TestClass]
    public class PunchesExpandedControllerTest
    {
        ...
        public PunchesExpandedControllerTest()
        {
            // Setup configuration
        ...
        public async System.Threading.Tasks.Task GetAllPunches_Should_ReturnSuccessfully()
        {
            ...
            var min = new DateTime(2022, 1, 1).ToString("yyyy-MM-ddTHH:mm:ssZ");
            var max = new DateTime(2022, 1, 2).ToString("yyyy-MM-ddTHH:mm:ssZ");

            var response = await client.GetAsync($"api/PunchesExpanded?min={min}&max={max}");
