...
namespace Brizbee.Api.Tests
{
    ...
    public class DepositsControllerTest
    {
        ...
        [TestMethod]
        public async System.Threading.Tasks.Task CreateDeposit_Valid_Succeeds()
        {
            // ----------------------------------------------------------------
            // Arrange
            // ----------------------------------------------------------------
            ...
            Assert.AreEqual(0.00M, balanceOfUndepositedFunds);
